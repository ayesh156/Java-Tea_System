...
//        System.out.println(evt.getKeyCode());
    ...
    private void initComponents() {
        ...
        jPanel20.setMinimumSize(new java.awt.Dimension(991, 400));
        jPanel20.setPreferredSize(new java.awt.Dimension(991, 400));
        ...
        jLabel17.setFont(new java.awt.Font("FMMalithi", 0, 26)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(15, 15, 18));
        jLabel17.setText("Y=oaO m%udKh");
        jLabel17.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 10, 1, new java.awt.Color(255, 255, 255)));
        jLabel17.setMaximumSize(new java.awt.Dimension(2147483647, 40));
        jLabel17.setMinimumSize(new java.awt.Dimension(296, 40));
        jLabel17.setPreferredSize(new java.awt.Dimension(296, 40));
        jLabel17.setVerifyInputWhenFocusTarget(false);
        jPanel25.add(jLabel17, java.awt.BorderLayout.PAGE_START);

        jTextField3.setEditable(false);
        jTextField3.setBackground(new java.awt.Color(245, 245, 245));
        jTextField3.setFont(new java.awt.Font("Iskoola Pota", 0, 24)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(15, 15, 18));
        ...
        jLabel21.setText("wvq lsÍï m%udKh");
        ...
        jPanel48.setMaximumSize(new java.awt.Dimension(400, 92));
        ...
        jLabel26.setPreferredSize(new java.awt.Dimension(296, 40));
        ...
        jTextField10.setMaximumSize(new java.awt.Dimension(2147483647, 52));
        jTextField10.setMinimumSize(new java.awt.Dimension(296, 52));
        jTextField10.setPreferredSize(new java.awt.Dimension(296, 52));
        jTextField10.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextField10KeyReleased(evt);
            }
        });
        jPanel48.add(jTextField10, java.awt.BorderLayout.PAGE_END);

        jPanel30.add(jPanel48, java.awt.BorderLayout.LINE_START);

        jPanel28.setBackground(new java.awt.Color(255, 255, 255));
        jPanel28.setMaximumSize(new java.awt.Dimension(300, 92));
        jPanel28.setMinimumSize(new java.awt.Dimension(300, 92));
        jPanel28.setPreferredSize(new java.awt.Dimension(551, 92));
        jPanel28.setLayout(new java.awt.BorderLayout());

        jPanel31.setBackground(new java.awt.Color(255, 255, 255));
        jPanel31.setMaximumSize(new java.awt.Dimension(32767, 20));
        jPanel31.setMinimumSize(new java.awt.Dimension(50, 20));
        ...
        jLabel15.setText("ffoksl o¿ tl;= lsÍï");
        ...
        jPanel22.setMinimumSize(new java.awt.Dimension(1011, 420));
        jPanel22.setPreferredSize(new java.awt.Dimension(1011, 420));
        jPanel22.setLayout(new javax.swing.BoxLayout(jPanel22, javax.swing.BoxLayout.LINE_AXIS));

        jPanel37.setBackground(new java.awt.Color(255, 255, 255));
        jPanel37.setMinimumSize(new java.awt.Dimension(950, 380));
        jPanel37.setPreferredSize(new java.awt.Dimension(950, 380));
    ...
    private void jTextField4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField4ActionPerformed
        ...
        if (supplier != null) {
            ...
            jTextField10.setText(supplier.getTransport_rate());
