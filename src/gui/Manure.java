...
import model.manure.ManureService;
import model.manure.ManureTableModel;
 ...
 * @author ECOTEC
 */
public class Manure extends javax.swing.JPanel {
    ...
    ManureTableModel manureTableModel;
    ...
    private static ManureService manureService;
    ...
    private void loadTable() {
        ...
        manureTableModel = new ManureTableModel();
        manureTableModel.setList(manureService.findAll(page, rowCountPerPage));
        jTable.setModel(manureTableModel);
    ...
    private void searchTable(String searchText) {
        ...
        totalData = manureService.findCount(searchText);
        rowCountPerPage = Integer.valueOf(jComboBoxPage.getSelectedItem().toString());
        Double totalPageD = Math.ceil(totalData.doubleValue() / rowCountPerPage.doubleValue());
        totalPage = totalPageD.intValue();
        ...
        manureTableModel = new ManureTableModel();
        manureTableModel.setList(manureService.find(searchText, page, rowCountPerPage));
        jTable.setModel(manureTableModel);
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        ...
        if (row >= 0 && row < jTable.getRowCount()) {
            ...
            ManureService ss = new ManureService();

            ManureModel s = ss.findByDataById(String.valueOf(jTable.getValueAt(row, 0)));
            ...
            try {
                ...
                logger.log(Level.WARNING, "Invalid date format. - Manure", e);
            }
                    ...
                    // Check if gross_qty is a valid number
                        ...
                        try {
                            ...
                            if ("iqrlskak".equals(jButton15.getText())) {
                                ...
                                ManureService manureService = new ManureService();
                                int fDataAvailability = manureService.findByDataExist(s_id, sqlDate, qty, price);
                                ...
                                if (fDataAvailability > 0) {
                                    ...
                                    try {
                                        ...
                                        ManureModel manureModel = new ManureModel();
                                        manureModel.setSupplier_id(s_id);
                                        manureModel.setSupplier_name(s_name);
                                        manureModel.setDate(sqlDate);
                                        manureModel.setQty(qtyStr);
                                        manureModel.setPrice(priceStr);

                                        // Call the save method in transportService
                                        ManureService saveTeaService = new ManureService();
                                        saveTeaService.save(manureModel);

                                    } catch (Exception e) {
                                        logger.log(Level.WARNING, "Manure", e);
                                        e.printStackTrace();
                                ...
                                if (row != -1) {  // Ensure a row is selected
                                    ...
                                    try {
                                        ...
                                        ManureService updateTeaService = new ManureService();
                                        updateTeaService.update(manureModel);
