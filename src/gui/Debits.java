...
import model.debits.DebitsService;
import model.debits.DebitsTableModel;
 ...
 * @author ECOTEC
 */
public class Debits extends javax.swing.JPanel {
    ...
    DebitsTableModel debitsTableModel;
    ...
    private static DebitsService debitsService;
    ...
    public Debits() {
        ...
        debitsService = new DebitsService();
    ...
    private void loadTable() {
        ...
        debitsTableModel = new DebitsTableModel();
        debitsTableModel.setList(debitsService.findAll(page, rowCountPerPage));
        jTable.setModel(debitsTableModel);
    ...
    private void searchTable(String searchText) {
        ...
        totalData = debitsService.findCount(searchText);
        rowCountPerPage = Integer.valueOf(jComboBoxPage.getSelectedItem().toString());
        Double totalPageD = Math.ceil(totalData.doubleValue() / rowCountPerPage.doubleValue());
        totalPage = totalPageD.intValue();
        ...
        debitsTableModel = new DebitsTableModel();
        debitsTableModel.setList(debitsService.find(searchText, page, rowCountPerPage));
        jTable.setModel(debitsTableModel);
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        ...
        if (row >= 0 && row < jTable.getRowCount()) {
            ...
            DebitsService ss = new DebitsService();

            DebitsModel s = ss.findByDataById(String.valueOf(jTable.getValueAt(row, 0)));
            ...
            try {
                ...
                logger.log(Level.WARNING, "Invalid date format. - Debits", e);
            }
                    ...
                    // Check if gross_qty is a valid number
                        ...
                        try {
                            ...
                            if ("iqrlskak".equals(jButton17.getText())) {
                                ...
                                DebitsService dolomiteService = new DebitsService();
                                ...
                                if (fDataAvailability > 0) {
                                    ...
                                    try {
                                        ...
                                        debitsModel.setSupplier_id(s_id);
                                        debitsModel.setSupplier_name(s_name);
                                        debitsModel.setDate(sqlDate);
                                        debitsModel.setPrice(priceStr);

                                        // Call the save method in transportService
                                        DebitsService saveTeaService = new DebitsService();
                                        saveTeaService.save(debitsModel);

                                    } catch (Exception e) {
                                        logger.log(Level.WARNING, "Debits", e);
                                        e.printStackTrace();
                                ...
                                if (row != -1) {  // Ensure a row is selected
                                    ...
                                    try {
                                        ...
                                        DebitsService updateTeaService = new DebitsService();
                                        updateTeaService.update(debitsModel);
        ...
        if (row == -1) {
            ...
            if (response == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    DebitsService debitsService = new DebitsService();
                    debitsService.delete(id);
