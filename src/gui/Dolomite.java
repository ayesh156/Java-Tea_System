...
import model.dolomite.*;
import model.dolomite.DolomiteModel;
import model.dolomite.DolomiteService;
import model.dolomite.DolomiteTableModel;
...
public class Dolomite extends javax.swing.JPanel {
    ...
    private static DolomiteService dolomiteService;
    ...
    public Dolomite() {
        ...
        dolomiteService = new DolomiteService();
    ...
    private void initComponents() {
        ...
        jPanel20.setMinimumSize(new java.awt.Dimension(991, 380));
        jPanel20.setPreferredSize(new java.awt.Dimension(991, 380));
        ...
        jPanel25.setMaximumSize(new java.awt.Dimension(400, 92));
        jPanel25.setMinimumSize(new java.awt.Dimension(270, 92));
        jPanel25.setPreferredSize(new java.awt.Dimension(270, 92));
        ...
        jPanel41.setMaximumSize(new java.awt.Dimension(400, 92));
        jPanel41.setLayout(new java.awt.BorderLayout());

        jLabel21.setBackground(new java.awt.Color(255, 255, 255));
        jLabel21.setFont(new java.awt.Font("FMMalithi", 0, 26)); // NOI18N
        jLabel21.setForeground(new java.awt.Color(15, 15, 18));
        jLabel21.setText("uqo,");
        ...
        jPanel41.add(jLabel21, java.awt.BorderLayout.PAGE_START);
        ...
        jTextField6.setMinimumSize(new java.awt.Dimension(296, 52));
        jTextField6.setPreferredSize(new java.awt.Dimension(296, 52));
        ...
        jPanel41.add(jTextField6, java.awt.BorderLayout.PAGE_END);

        jPanel39.add(jPanel41, java.awt.BorderLayout.CENTER);

        jPanel45.setBackground(new java.awt.Color(255, 255, 255));
        jPanel45.setMaximumSize(new java.awt.Dimension(400, 92));
        jPanel45.setMinimumSize(new java.awt.Dimension(250, 92));
        jPanel45.setPreferredSize(new java.awt.Dimension(250, 92));
        ...
        jPanel30.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 1, 1, 1));
        jPanel30.setMaximumSize(new java.awt.Dimension(2147483647, 90));
        jPanel30.setMinimumSize(new java.awt.Dimension(900, 90));
        jPanel30.setPreferredSize(new java.awt.Dimension(900, 90));
        jPanel30.setLayout(new java.awt.BorderLayout(58, 0));

        jPanel28.setBackground(new java.awt.Color(255, 255, 255));
        jPanel28.setMaximumSize(new java.awt.Dimension(300, 80));
        jPanel28.setMinimumSize(new java.awt.Dimension(300, 92));
        jPanel28.setPreferredSize(new java.awt.Dimension(551, 80));
        jPanel28.setLayout(new java.awt.BorderLayout());

        jPanel31.setBackground(new java.awt.Color(255, 255, 255));
        jPanel31.setMaximumSize(new java.awt.Dimension(32767, 20));
        jPanel31.setMinimumSize(new java.awt.Dimension(50, 30));
        jPanel31.setName(""); // NOI18N
        jPanel31.setPreferredSize(new java.awt.Dimension(912, 30));
        ...
        jPanel32.setMinimumSize(new java.awt.Dimension(50, 52));
        jPanel32.setPreferredSize(new java.awt.Dimension(50, 52));
        ...
        jPanel42.setMaximumSize(new java.awt.Dimension(400, 52));
        jPanel42.setMinimumSize(new java.awt.Dimension(400, 52));
        jPanel42.setPreferredSize(new java.awt.Dimension(400, 52));
        jPanel42.setLayout(new java.awt.BorderLayout(15, 0));
        ...
        jPanel42.add(jButton16, java.awt.BorderLayout.LINE_END);
        ...
        jPanel42.add(jButton18, java.awt.BorderLayout.LINE_START);

        jPanel32.add(jPanel42, java.awt.BorderLayout.LINE_END);

        jPanel28.add(jPanel32, java.awt.BorderLayout.PAGE_END);

        jPanel30.add(jPanel28, java.awt.BorderLayout.CENTER);

        jPanel20.add(jPanel30, java.awt.BorderLayout.PAGE_END);
        ...
        jPanel22.setMinimumSize(new java.awt.Dimension(1011, 440));
        jPanel22.setPreferredSize(new java.awt.Dimension(1011, 440));
    ...
    private void loadTable() {
        ...
        totalData = dolomiteService.count();
        ...
        dolomiteTableModel = new DolomiteTableModel();
        dolomiteTableModel.setList(dolomiteService.findAll(page, rowCountPerPage));
        jTable.setModel(dolomiteTableModel);
    ...
    private void searchTable(String searchText) {
        ...
        totalData = dolomiteService.findCount(searchText);
        rowCountPerPage = Integer.valueOf(jComboBoxPage.getSelectedItem().toString());
        Double totalPageD = Math.ceil(totalData.doubleValue() / rowCountPerPage.doubleValue());
        totalPage = totalPageD.intValue();
        ...
        dolomiteTableModel = new DolomiteTableModel();
        dolomiteTableModel.setList(dolomiteService.find(searchText, page, rowCountPerPage));
        jTable.setModel(dolomiteTableModel);
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        ...
        if (row >= 0 && row < jTable.getRowCount()) {
            ...
            DolomiteService ss = new DolomiteService();

            DolomiteModel s = ss.findByDataById(String.valueOf(jTable.getValueAt(row, 0)));
            ...
            try {
                ...
                logger.log(Level.WARNING, "Invalid date format. - Dolomite", e);
            }
                    ...
                    // Check if gross_qty is a valid number
                        ...
                        try {
                            ...
                            if ("iqrlskak".equals(jButton15.getText())) {
                                ...
                                DolomiteService dolomiteService = new DolomiteService();
                                int fDataAvailability = dolomiteService.findByDataExist(s_id, sqlDate, qty, price);
                                ...
                                if (fDataAvailability > 0) {
                                    ...
                                    try {
                                        ...
                                        DolomiteModel dolomiteModel = new DolomiteModel();
                                        dolomiteModel.setSupplier_id(s_id);
                                        dolomiteModel.setSupplier_name(s_name);
                                        dolomiteModel.setDate(sqlDate);
                                        dolomiteModel.setQty(qtyStr);
                                        dolomiteModel.setPrice(priceStr);

                                        // Call the save method in transportService
                                        DolomiteService saveTeaService = new DolomiteService();
                                        saveTeaService.save(dolomiteModel);
                                ...
                                if (row != -1) {  // Ensure a row is selected
                                    ...
                                    try {
                                        ...
                                        DolomiteService updateTeaService = new DolomiteService();
                                        updateTeaService.update(dolomiteModel);
