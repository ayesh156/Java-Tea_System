...
public class Pagination extends JPanel {
    ...
    private void changePage(int current, int totalPage) {
        ...
        // First Button
        JButton cmdFirst = paginationItemRender.createPaginationItem("First", true, false, page.isFirst());
        cmdFirst.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setPagegination(1, totalPage);
                runEvent();
            }
        });
        add(cmdFirst);
        ...
        // Last Button
        JButton cmdLast = paginationItemRender.createPaginationItem("Last", false, true, page.isLast());
        cmdLast.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setPagegination(page.getTotalPage(), totalPage);
                runEvent();
            }
        });
        add(cmdLast);
